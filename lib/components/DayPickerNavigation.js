...
function DayPickerNavigation(props) {
  ...
  return _react2['default'].createElement('div', { className: navClassNames }, _react2['default'].createElement('button', {
    type: 'button',
    'aria-label': phrases.jumpToPrevMonth,
    className: (0, _classnames2['default'])(prevClassNames, 'DayPickerNavigation__prev--month'),
    ...
    className: (0, _classnames2['default'])(nextClassNames, 'DayPickerNavigation__next--month'),
  ...
  }, navNextIcon), !isVerticalScrollable && isYearsEnabled && _react2['default'].createElement('button', {
    type: 'button',
    'aria-label': phrases.jumpToPrevYear,
    className: (0, _classnames2['default'])(prevClassNames, 'DayPickerNavigation__prev--year'),
  ...
  }, navPrevIcon), !isVerticalScrollable && isYearsEnabled && _react2['default'].createElement('button', {
    type: 'button',
    'aria-label': phrases.jumpToNextYear,
    className: (0, _classnames2['default'])(nextClassNames, 'DayPickerNavigation__next--year'),
