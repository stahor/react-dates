  ...
  _createClass(CalendarMonth, [{
    ...
    value: function () {
      function render() {
        ...
        var monthTitle = renderMonth ? renderMonth(month) : month.format(isYearsEnabled ? monthFormat.replace(/Y+/g, '') : monthFormat);
        var yearTitle = isYearsEnabled ? month.format('YYYY') : null;
        ...
        return _react2['default'].createElement('div', { className: calendarMonthClasses, 'data-visible': isVisible }, _react2['default'].createElement('table', null, _react2['default'].createElement('caption', { className: 'CalendarMonth__caption js-CalendarMonth__caption' }, _react2['default'].createElement('span', { className: 'CalendarMonth__caption CalendarMonth__month-title' }, monthTitle), _react2['default'].createElement('span', { className: 'CalendarMonth__caption CalendarMonth__year-title' }, yearTitle)), _react2['default'].createElement('tbody', { className: 'js-CalendarMonth__grid' }, weeks.map(function (week, i) {
